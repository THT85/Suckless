...
static const char *fonts[]          = { "ComicShannaMonoNerdFont:size=14" };
static const char dmenufont[]       = "ComicShannsMonoNerdFont:size=14";
...
static const Layout layouts[] = {
	...
	{ " 󰙖  ",      NULL },    /* no layout function means floating behavior */
	{ "[M]",      monocle },
};
